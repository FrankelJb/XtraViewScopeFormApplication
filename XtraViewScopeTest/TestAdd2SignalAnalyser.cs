    ...
    public class TestAdd2SignalAnalyser
    {
        ...
        public Nibble createNibble(int nibbleNum)
        {
            ...
            switch (nibbleNum)
            {
                case 0:
                    {
                        nibble.PulseEndTime = nibble.PulseStartTime + new PrecisionTimeSpan(0.0006);
                        nibble.NoiseStartTime = nibble.PulseEndTime;
                        nibble.NoiseEndTime = nibble.NoiseStartTime + new PrecisionTimeSpan(0.0004);
                        break;
                    }
                case 1:
                    {
                        nibble.PulseEndTime = nibble.PulseStartTime + new PrecisionTimeSpan(0.0007);
                        nibble.NoiseStartTime = nibble.PulseEndTime;
                        nibble.NoiseEndTime = nibble.NoiseStartTime + new PrecisionTimeSpan(0.0004);
                        break;
                    }
                case 2:
                    {
                        nibble.PulseEndTime = nibble.PulseStartTime + new PrecisionTimeSpan(0.00061);
                        nibble.NoiseStartTime = nibble.PulseEndTime;
                        nibble.NoiseEndTime = nibble.NoiseStartTime + new PrecisionTimeSpan(0.0006);
                        break;
                    }
                case 3:
                    {
                        nibble.PulseEndTime = nibble.PulseStartTime + new PrecisionTimeSpan(0.0008);
                        nibble.NoiseStartTime = nibble.PulseEndTime;
                        nibble.NoiseEndTime = nibble.NoiseStartTime + new PrecisionTimeSpan(0.0006);
                        break;
                    }
                case 4:
                    {
                        nibble.PulseEndTime = nibble.PulseStartTime + new PrecisionTimeSpan(0.0008);
                        nibble.NoiseStartTime = nibble.PulseEndTime;
                        nibble.NoiseEndTime = nibble.NoiseStartTime + new PrecisionTimeSpan(0.0007);
                        break;
                    }
                case 5:
                    {
                        nibble.PulseEndTime = nibble.PulseStartTime + new PrecisionTimeSpan(0.0008);
                        nibble.NoiseStartTime = nibble.PulseEndTime;
                        nibble.NoiseEndTime = nibble.NoiseStartTime + new PrecisionTimeSpan(0.000845);
                        break;
                    }
                case 6:
                    {
                        nibble.PulseEndTime = nibble.PulseStartTime + new PrecisionTimeSpan(0.0009);
                        nibble.NoiseStartTime = nibble.PulseEndTime;
                        nibble.NoiseEndTime = nibble.NoiseStartTime + new PrecisionTimeSpan(0.0009);
                        break;
                    }
                case 7:
                    {
                ...
                case 8:
                    {
                        nibble.PulseEndTime = nibble.PulseStartTime + new PrecisionTimeSpan(0.001);
                        nibble.NoiseStartTime = nibble.PulseEndTime;
                        nibble.NoiseEndTime = nibble.NoiseStartTime + new PrecisionTimeSpan(0.0011);
                        break;
                    }
                case 9:
                    {
                        nibble.PulseEndTime = nibble.PulseStartTime + new PrecisionTimeSpan(0.001);
                        nibble.NoiseStartTime = nibble.PulseEndTime;
                        nibble.NoiseEndTime = nibble.NoiseStartTime + new PrecisionTimeSpan(0.0012);
                        break;
                    }
                case 10:
                    {
                        nibble.PulseEndTime = nibble.PulseStartTime + new PrecisionTimeSpan(0.001);
                        nibble.NoiseStartTime = nibble.PulseEndTime;
                        nibble.NoiseEndTime = nibble.NoiseStartTime + new PrecisionTimeSpan(0.0013);
                        break;
                    }
                case 11:
                    {
                        nibble.PulseEndTime = nibble.PulseStartTime + new PrecisionTimeSpan(0.001);
                        nibble.NoiseStartTime = nibble.PulseEndTime;
                        nibble.NoiseEndTime = nibble.NoiseStartTime + new PrecisionTimeSpan(0.0015);
                        break;
                    }
                case 12:
                    {
                        nibble.PulseEndTime = nibble.PulseStartTime + new PrecisionTimeSpan(0.001);
                        nibble.NoiseStartTime = nibble.PulseEndTime;
                        nibble.NoiseEndTime = nibble.NoiseStartTime + new PrecisionTimeSpan(0.0016);
                        break;
                    }
                case 13:
                    {
                        nibble.PulseEndTime = nibble.PulseStartTime + new PrecisionTimeSpan(0.001);
                        nibble.NoiseStartTime = nibble.PulseEndTime;
                        nibble.NoiseEndTime = nibble.NoiseStartTime + new PrecisionTimeSpan(0.0017);
                        break;
                    }
                case 14:
                    {
                ...
                case 15:
                    {
                        nibble.PulseEndTime = nibble.PulseStartTime + new PrecisionTimeSpan(0.001);
                        nibble.NoiseStartTime = nibble.PulseEndTime;
                        nibble.NoiseEndTime = nibble.NoiseStartTime + new PrecisionTimeSpan(0.002);
                        break;
                    }
            }
